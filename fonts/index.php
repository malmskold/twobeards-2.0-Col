...
<link rel="stylesheet" type="text/css" media="all" href="css/ie6.css"/><![endif]-->
    ...
    <body id="index" class="home">
        ...
        <section class="start_wrapper">
            ...
            <a class="start_nav_box" href="index_programmering.php">
                <div class="navbox prog">
                    <div class="navbox_images prog_icon">
                        <span class="iconicstroke-cog icon"></span>
                    </div>
            ...
            <a class="start_nav_box" href="index_digitaltskapande.php">
                <div class="navbox digi">
                    <div class="navbox_images digi_icon">
